...
interface MultisigWalletV10Interface extends ethers.utils.Interface {
  functions: {
...
export class MultisigWalletV10 extends Contract {
  ...
  interface: MultisigWalletV10Interface;

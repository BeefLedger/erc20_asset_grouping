...
interface ERC721BeefLedgerV11Interface extends ethers.utils.Interface {
  functions: {
...
export class ERC721BeefLedgerV11 extends Contract {
  ...
  interface: ERC721BeefLedgerV11Interface;

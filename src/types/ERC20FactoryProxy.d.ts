...
interface ERC20FactoryProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20FactoryProxy extends Contract {
  ...
  interface: ERC20FactoryProxyInterface;

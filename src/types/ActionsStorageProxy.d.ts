...
interface ActionsStorageProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class ActionsStorageProxy extends Contract {
  ...
  interface: ActionsStorageProxyInterface;

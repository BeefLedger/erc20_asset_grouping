...
interface ResourceActionsProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class ResourceActionsProxy extends Contract {
  ...
  interface: ResourceActionsProxyInterface;
